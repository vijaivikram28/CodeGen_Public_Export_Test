...
HAL_StatusTypeDef BMS_CAN_ParseMessage(
...
uint8_t BMS_CAN_ExtractRackID(uint32_t msg_id);

void BMS_CAN_ResetMessageContext(
    BMS_CANMessageContext* message_ctx
);
